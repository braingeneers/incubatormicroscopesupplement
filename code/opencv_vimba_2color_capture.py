...
exposure_seconds = 3
photo_interval_hours = 0.05
camera_gain = 10
path = "C:\\Users\\brain\\Documents\\santhosh10_41625\\"
############ DON'T TOUCH THE REST :) ######################

EXPOSURE = exposure_seconds * 1000000
PHOTOINTERVAL = 60 * 60 * photo_interval_hours
